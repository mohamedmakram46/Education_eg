...
• These analyses can be used to support educational decisions or improve performance in schools ''')
    ...
    df2 = df[(df['father degree']== father_degree) & (df['education type'] == education_type) &(df['student year']== student_year) &(df['mother degree']== mother_degree) & (df['Average Score'] == Average_Score)]
